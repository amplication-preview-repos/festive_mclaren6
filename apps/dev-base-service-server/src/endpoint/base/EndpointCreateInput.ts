...
class EndpointCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ApiDocumentationCreateNestedManyWithoutEndpointsInput,
  })
  @ValidateNested()
  @Type(() => ApiDocumentationCreateNestedManyWithoutEndpointsInput)
  @IsOptional()
  @Field(() => ApiDocumentationCreateNestedManyWithoutEndpointsInput, {
    nullable: true,
  })
  apiDocumentations?: ApiDocumentationCreateNestedManyWithoutEndpointsInput;
}

export { EndpointCreateInput as EndpointCreateInput };
