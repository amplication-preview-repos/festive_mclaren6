...
@InputType()
class FieldModelCreateNestedManyWithoutSchemataInput {
...
export { FieldModelCreateNestedManyWithoutSchemataInput as FieldModelCreateNestedManyWithoutSchemataInput };
