...
class SchemaCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => FieldModelCreateNestedManyWithoutSchemataInput,
  })
  @ValidateNested()
  @Type(() => FieldModelCreateNestedManyWithoutSchemataInput)
  @IsOptional()
  @Field(() => FieldModelCreateNestedManyWithoutSchemataInput, {
    nullable: true,
  })
  fields?: FieldModelCreateNestedManyWithoutSchemataInput;
}

export { SchemaCreateInput as SchemaCreateInput };
