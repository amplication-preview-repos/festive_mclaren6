...
@InputType()
class SubscriptionUpdateManyWithoutCollectionsInput {
...
export { SubscriptionUpdateManyWithoutCollectionsInput as SubscriptionUpdateManyWithoutCollectionsInput };
