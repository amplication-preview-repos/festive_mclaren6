...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [UserSession], { name: "userSessions" })
  async findUserSessions(
    @graphql.Parent() parent: User,
    @graphql.Args() args: UserSessionFindManyArgs
  ): Promise<UserSession[]> {
    const results = await this.service.findUserSessions(parent.id, args);
  ...
  @graphql.ResolveField(() => [WebSocket], { name: "webSockets" })
  async findWebSockets(
    @graphql.Parent() parent: User,
    @graphql.Args() args: WebSocketFindManyArgs
  ): Promise<WebSocket[]> {
    const results = await this.service.findWebSockets(parent.id, args);
