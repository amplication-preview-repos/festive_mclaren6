...
@InputType()
class SubscriptionCreateNestedManyWithoutQueriesInput {
...
export { SubscriptionCreateNestedManyWithoutQueriesInput as SubscriptionCreateNestedManyWithoutQueriesInput };
